...
public class PowerElementsSeedData {
    public static final List<PowerElement> powerElements = Arrays.asList(
            ...
            new PowerElement(4, "Wind Farm", R.drawable.wind_farm, "power=generator;generator:method=photovoltaic;generator:source=solar", R.string.desc_wind_farm),
            new PowerElement(5, "Solar PV", R.drawable.solar_panels, "power=generator;generator:method=wind_turbine;generator:source=wind", R.string.desc_solar_panels),
